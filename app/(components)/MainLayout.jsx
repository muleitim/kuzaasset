...
import { Box, Flex, Heading, VStack, HStack, Button, Portal, Link, Drawer } from "@chakra-ui/react";
  ...
  return (
    <Flex minH="100vh" bg="gray.50" color="gray.800">
      ...
      >
        ...
        <Box mt="auto" textAlign="center" fontSize="sm" color="gray.500">
      ...
      >
        <Drawer.Root open={open} onOpenChange={(e) => setOpen(Boolean(e.open))} placement="start">
          ...
          <Portal>
            ...
            <Drawer.Positioner>
              <Drawer.Content>
                <Drawer.Header>
                  <Heading size="sm">Kuza Asset Management</Heading>
                </Drawer.Header>
        ...
        <Heading size="sm" fontWeight="semibold">Kuza Asset Management</Heading>
        <Box w="40px" />
      </Flex>
